...
<body class="h-screen flex items-center justify-center" style="background-image: url('http://wonderfulengineering.com/wp-content/uploads/2014/01/beautiful-wallpaper-29.jpg'); background-size: cover;">
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <input type="hidden" name="userForm" value="user">
            <div class="mb-4 flex items-center">
                <i class="fas fa-building text-gray-700 mr-2"></i>
                <input type="text" placeholder="Enter your Wing" class="w-full p-2 border-b-2 border-gray-300 focus:outline-none focus:border-black">
            </div>
            <div class="mb-4 flex items-center">
                <i class="fas fa-door-open text-gray-700 mr-2"></i>
                <input type="text" placeholder="Enter your Flat Number" class="w-full p-2 border-b-2 border-gray-300 focus:outline-none focus:border-black">
            </div>
            <div class="mb-4 flex items-center">
                <i class="fas fa-lock text-gray-700 mr-2"></i>
                <input type="password" placeholder="Enter Password" class="w-full p-2 border-b-2 border-gray-300 focus:outline-none focus:border-black">
            </div>
        ...
        <input type="hidden" name="adminForm" value="admin">
            <div class="mb-4 flex items-center">
                <i class="fas fa-user text-gray-700 mr-2"></i>
                <input type="text" placeholder="Enter Admin ID" class="w-full p-2 border-b-2 border-gray-300 focus:outline-none focus:border-black">
            </div>
            <div class="mb-4 flex items-center">
                <i class="fas fa-lock text-gray-700 mr-2"></i>
                <input type="password" placeholder="Enter Password" class="w-full p-2 border-b-2 border-gray-300 focus:outline-none focus:border-black">
